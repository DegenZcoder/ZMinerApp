        ...
        <main className="flex min-h-screen flex-col items-center justify-center p-12 space-y-12 bg-gradient-to-br from-black via-gray-900 to-black text-white">
            ...
            <div className="space-y-4 mt-10 w-full max-w-2xl">
                ...
                <div className="space-x-4">
                    <button onClick={handleStake} className="px-4 py-2 bg-green-600 rounded hover:bg-green-700 shadow-lg">Approve + Stake</button>
            ...
            <div className="mt-20 w-full max-w-4xl space-y-6">
                ...
                <iframe
                    src="https://www.dextools.io/app/en/base/pair-explorer/0xec35ba8f542abe673b16911fca390f24a1c66e53"
                    width="100%"
                    height="600"
                    style={{ border: "0", borderRadius: "12px" }}
                    title="Chart"

...
// Get staking information and claimable rewards
export async function getStakingInfo(userAddress) {
    ...
    const claimable = await contract.getClaimable(userAddress, currentWeek - 1);
...
export async function claimReward() {
    ...
    const currentWeek = await contract.getCurrentWeek();
    const weekToClaim = currentWeek - 1;
